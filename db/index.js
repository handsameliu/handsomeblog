...
var ArticleSchema = new mongoose.Schema({
    ...
    comments:[{user:{type:ObjectId,ref:'User'},createAt:{type:Date,default:Date.now()},content:String}]//评论数组，里面放的是对象
});
//两个参数表示定会义一个模型，一个参数表示获取一个模型
var ArticleModul = mongoose.model('Article',ArticleSchema);
